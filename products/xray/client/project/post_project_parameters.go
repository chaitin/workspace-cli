...
func (o *PostProjectParams) WithBody(body *models.CreateProjectBody) *PostProjectParams {
	o.SetBody(body)
	return o
}

// SetBody adds the body to the post project params
func (o *PostProjectParams) SetBody(body *models.CreateProjectBody) {
	o.Body = body
}
