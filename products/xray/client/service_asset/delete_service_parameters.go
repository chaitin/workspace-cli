...
// WithBody adds the body to the delete service params
func (o *DeleteServiceParams) WithBody(body []*models.DeleteServiceItem) *DeleteServiceParams {
	o.SetBody(body)
	return o
}

// SetBody adds the body to the delete service params
func (o *DeleteServiceParams) SetBody(body []*models.DeleteServiceItem) {
	o.Body = body
}

// WithProjectID adds the projectID to the delete service params
func (o *DeleteServiceParams) WithProjectID(projectID int64) *DeleteServiceParams {
	o.SetProjectID(projectID)
	return o
}

// SetProjectID adds the projectId to the delete service params
func (o *DeleteServiceParams) SetProjectID(projectID int64) {
