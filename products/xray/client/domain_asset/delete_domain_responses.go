...
func (o *DeleteDomainReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (any, error) {
	...
	case 200:
		...
		return result, nil
	default:
		return nil, runtime.NewAPIError("[DELETE /domain] DeleteDomain", response, response.Code())
	}
}
...
func (o *DeleteDomainOK) Error() string {
	...
	return fmt.Sprintf("[DELETE /domain][%d] deleteDomainOK %s", 200, payload)
}
...
func (o *DeleteDomainOK) GetPayload() *models.APIResponse {
	return o.Payload
}
